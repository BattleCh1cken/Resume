...
\simpleSkill{Team management}
\simpleSkill{Problem-solving and critical thinking}
\simpleSkill{Interpersonal Communication}
\simpleSkill{Self-awareness}
\simpleSkill{Self-motivated}
...
\neghvspace
\cvsubsection{\faPuzzlePiece}{Hobbies \& Interests}
\svspace
...
\begin{itemize}
	\item[\faAngleRight] \href{https://github.com/BattleCh1cken/dotfiles}{\textbf{Dotfiles:}} My personal configuration files for my computers, mangaged with the NixOS operating system.
		\negxvspace{}
